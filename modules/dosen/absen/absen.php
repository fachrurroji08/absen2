...
$except = ['startAbsen', 'get_dosen_location', 'simpan_absensi', 'do_buat_pertemuan', 'detail_kehadiran', 'do_lihat_pertemuan', 'getLocation'];
...
$actionList = array(
    ...
    'do_buat_pertemuan', 'lihat_pertemuan', 'detail_kehadiran', 'do_lihat_pertemuan', 'getLocation'
);
